Redmine::OmniAuthSAML::Base.configure do |config|
  config.saml = {
    :assertion_consumer_service_url => "https://manage.prj003.gst01.dev:10443/auth/saml/callback", # OmniAuth callback URL
    :issuer                         => "https://manage.prj003.gst01.dev:10443",      # The issuer name / entity ID. Must be an URI as per SAML 2.0 spec.
    :single_logout_service_url      => "https://manage.prj003.gst01.dev:10443/auth/saml/sls",      # The SLS (logout) callback URL
    ...
    :idp_slo_target_url             => "https://manage.prj003.gst01.dev:10443/auth/saml/sls",
